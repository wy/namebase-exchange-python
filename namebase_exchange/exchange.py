...
class Exchange:
    ...
    def get_exchange_info(self):
        ...
        Use to test connectivity to the Rest API.
    ...
    def get_depth(self, symbol: Symbol, limit: int = 100):
        """
        Function to get the Order Book Depth for a given Symbol.
    ...
    def get_trade(self, symbol: Symbol, trade_id=None, limit=100, receive_window: Optional[int] = None):
        """
        Function to get older trades.
    ...
    def get_kline(self, symbol: Symbol, interval: str, start_time: Optional[int] = None,
                  end_time: Optional[int] = None, limit: int = 100):
        """
        Function to get Kline (candlestick) bars for a given symbol.

        get_kline(symbol=Symbol.HNSBTC, interval="1h", limit=100)
    ...
    def get_ticker_day(self, symbol: Symbol):
        """
        Function to get 24 hour rolling window price change statistics.
    ...
    def get_ticker_price(self, symbol: Symbol):
        """
        Function to get latest price for a symbol or symbols.
    ...
    def get_ticker_supply(self, asset: Asset):
        """
        Function to get the circulating supply for the provided asset.
    ...
    def get_order(self, symbol: Symbol, order_id: int,
                  receive_window: Optional[int] = None):
        """
        Function to get an order's status.
    ...
    def get_account_information(self, receive_window: Optional[int] = None):
        """
        Function to get basic account information.
